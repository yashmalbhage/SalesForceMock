      ...
      <Container maxWidth="lg">
        <Grid container spacing={0} sx={{ flexDirection: { xs: 'column', md: 'unset' } }}>
            ...
            >
              <Box sx={{ mb: 3 }}>
                ...
                >
                  ...
                  >
                    interview with a mock interview
              ...
              <Box sx={{ mb: 4, width: { xs: '100%', md: '70%' } }}>
                <Typography sx={{ color: 'text.secondary', lineHeight: 1.6 }}>
                  {
                    "Get personalized feedback and improve your chances of landing your dream job in Salesfocre."
                  }
                </Typography>
              </Box>
              <Box sx={{ '& button': { mr: 2 } }}>
          ...
          <Grid item xs={12} md={5} sx={{ position: 'relative' }}>
            ...
            <Box sx={{ lineHeight: 0 }}>
              <Image src="/images/7566.jpg" width={885} height={787} alt="Hero img" />
            </Box>
          </Grid>
        </Grid>
